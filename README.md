...
## Настройка Codex на новом ноутбуке

Отправьте агенту файл [CODEX-SETUP-V2.md](CODEX-SETUP-V2.md). Он проведет безопасную настройку на Windows, macOS или Linux, сохранит существующие файлы, подключит архитектуру V2 и проверит локальную работу с приватным GitHub.
